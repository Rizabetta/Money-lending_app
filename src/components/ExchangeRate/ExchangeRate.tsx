    ...
    return (
        ...
        <div>
            ...
            <ul className="exchangeRate__currency-table">
                {rateTable1.map(item => <div key={item.index}>
                <li className="exchangeRate__currency">{item.rate}</li>
                <li className="exchangeRate__value" id={item.id}></li>
                </div>)}
            </ul>
            <ul className="exchangeRate__currency-table">
            {rateTable2.map(item => <div key={item.index}> 
                <li className="exchangeRate__currency">{item.rate}</li>
                <li className="exchangeRate__value" id={item.id}></li>
                </div>)}   
            </ul>
            <a href="# " className="exchangeRate__courses-a">All courses</a>
        </div>
        <div className="exchangeRate__container">
            <time className="exchangeRate__time">Update every 15 minutes, MSC 09.08.2022</time>
